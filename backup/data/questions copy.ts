...
export const questions: QuizData = {
  ...
  tujuanNaratif2: [
    {
      question: "Apa tujuan utama dari menyajikan cerita dalam teks naratif?",
      answers: {
    ...
    {
      question: "Mengapa penulis teks naratif sering menyampaikan pesan moral?",
      answers: {
  ...
  fungsiNaratif3: [
    ...
    {
      question: "Apa yang dimaksud dengan fungsi edukatif dalam teks naratif?",
      answers: {
  ...
  jenisNaratif4: [
    ...
    {
      question: "Apa yang menjadi fokus utama dalam teks naratif sugestif?",
      answers: {
  ...
  perbedaanNaratif5: [
    ...
    {
      question: "Gaya bahasa apa yang digunakan dalam teks naratif sugestif?",
      answers: {
    ...
    {
      question: "Dalam konteks apa teks naratif ekspositoris sering digunakan?",
      answers: {
  ...
  ciriNaratif6: [
    ...
    {
      question: "Apa yang dimaksud dengan alur cerita dalam teks naratif?",
      answers: {
    ...
    {
      question: "Dalam teks naratif, apa fungsi dari konflik dan resolusi?",
      answers: {
