...
import InfoModal from "../../components/InfoModal"; // Import the modal component
...
export default function Home() {
  ...
  const [isModalVisible, setModalVisible] = useState(true); // State for modal visibility
    ...
    <View style={styles.backgroundImage}>
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.menuSection}>
          <Text style={[styles.menuTitle, { color: colors.text }]}>FAREL</Text>
          ...
          <TouchableOpacity
            ...
            <MaterialCommunityIcons
              ...
              color="#fff"
            />
            <Text style={styles.quizButtonText}>Tujuan Pembelajaran</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.quizButton}
            ...
            <MaterialCommunityIcons
              ...
              color="#fff"
            />
            <Text style={styles.quizButtonText}>Materi Pembelajaran</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            <MaterialCommunityIcons
              ...
              color="#fff"
            />
            <Text style={styles.quizButtonText}>Kelas Interaktif</Text>
          </TouchableOpacity>
