...
export default function NaratifText() {
  return (
    <ParallaxScrollView
      ...
      <Collapsible title="Definisi Teks Naratif">
        <ThemedText>
          Teks naratif adalah jenis teks yang menceritakan suatu peristiwa atau
      ...
      <Collapsible title="Tujuan Teks Naratif">
      ...
      <Collapsible title="Fungsi Teks Naratif">
      ...
      <Collapsible title="Jenis-jenis Teks Naratif">
      ...
      <Collapsible title="Perbedaan Teks Naratif Ekspositoris dan Sugestif">
      ...
      <Collapsible title="Ciri-ciri Teks Naratif">
      ...
      <Collapsible title="Struktur Teks Naratif">
      ...
      <Collapsible title="Contoh Teks Naratif">
